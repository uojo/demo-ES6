...
(function (global, factory) {
  ...
  Dep.prototype.depend = function depend() {
    if (Dep.target) {
      // Log('Dep.depend()', Dep.target);
      Dep.target.addDep(this)
    }
  };

  Dep.prototype.notify = function notify() {
    Log('Dep.notify', this.subs);
  ...
  var Watcher = function Watcher(
    ...
    const lg = Log.group()('Watcher.constructor')
  ...
  Watcher.prototype.get = function get() {
    const lg = Log.group()('Watcher.get')
    pushTarget(this)
  ...
  function defineReactive$$1(
    ...
    const lg = Log.group()('defineReactive')
    lg('input', obj, key, val)
    var dep = new Dep()
  ...
  function lifecycleMixin(Vue) {
    Vue.prototype._mount = function (
      ...
      const lg2 = Log.group()('new Watcher()')
      vm._watcher = new Watcher(vm, function () {
        Log('Watcher.expOrFn()', 'vm._update()');
    ...
    Vue.prototype._update = function (vnode, hydrating) {
      const lg = Log.group()('Vue._update')
      lg('input.vnode', vnode)
      var vm = this
      if (vm._isMounted) {
  ...
  function initMixin(Vue) {
    Vue.prototype._init = function (options) {
      ...
      const lg2 = Log.group()('initRender')
      initRender(vm)
      lg2.end()
    }
  ...
  function parse(
    ...
    const lg = Log.group()('template > ast')
    ...
    lg.return(root) // root => eg.{type:1, tag:'div', parent:undefined, children:[], attrs:[], attrsList:[] }
    return root
  }
  ...
  function compile$1(
    ...
    console.log('ast > renderCode', code);
    return {
      ast: ast,
      render: code.render,
  ...
  function compileToFunctions(
    ...
    const lg = Log.group()('compile: template > render')
    ...
    var res = {}
    const lg2 = Log.group()('template > ast > renderCode')
